...
4. Горизонтальное меню нужно сделать с использованием Unordered list ( <ul>). При открытии внутренних страниц требуется выделить соответствующий пункт меню, и сделать его не "кликабельным" (убрать с него гиперссылку).
